...
namespace DeanarySoft.Migrations
{
    ...
    partial class DeanaryContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Contactphone", b =>
                {
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Equipment", b =>
                {
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Fullrequestinformation", b =>
                {
                    ...
                    b.Property<DateOnly?>("ДатаВводаВЭксплуотацию")
                        .HasColumnType("date")
                        .HasColumnName("Дата ввода в эксплуатацию");
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Model", b =>
                {
                    b.Property<int>("ModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Request", b =>
                {
                    b.Property<string>("Description")
                        .HasColumnType("text")
                        .HasColumnName("description");
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Staff", b =>
                {
                    b.Property<int>("StaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Status", b =>
                {
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.TypeStatus", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Contactphone", b =>
                {
                    b.HasOne("DeanarySoft.DataLayer.DataBaseClasses.Staff", "Staff")
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Equipment", b =>
                {
                    b.HasOne("DeanarySoft.DataLayer.DataBaseClasses.Model", "Model")
                        .WithMany("Equipment")
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Request", b =>
                {
                    b.HasOne("DeanarySoft.DataLayer.DataBaseClasses.Equipment", "Equipment")
                        .WithMany()
            ...
            modelBuilder.Entity("DeanarySoft.DataLayer.DataBaseClasses.Status", b =>
                {
                    ...
                    b.HasOne("DeanarySoft.DataLayer.DataBaseClasses.TypeStatus", "Type")
                        .WithMany()
